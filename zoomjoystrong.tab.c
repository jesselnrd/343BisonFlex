...
static const char *const yytname[] =
{
  ...
  "CIRCLE", "RECTANGLE", "SET_COLOR", "INTEGER", "FLOAT", "$accept",
  "program", "statement", "statement_list", YY_NULLPTR
};
#endif
